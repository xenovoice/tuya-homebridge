...
const ClothesDryingRackAccessory = require('./lib/clothes_drying_rack_accessory')
  ...
  addAccessory(device) {
    ...
    switch (deviceType) {
      ...
      case 'cl':
        ...
        break;
      case 'lyj':
        deviceAccessory = new ClothesDryingRackAccessory(this, homebridgeAccessory, device);
        this.accessories.set(uuid, deviceAccessory.homebridgeAccessory);
        this.deviceAccessories.set(uuid, deviceAccessory);
        break;
      case 'mcs':
